...
%>
	...
	<section id="pageList" style="text-align : center">
							...
							%>
							<a href="recentlyViewed.do?page=<%=startPage%>" id="paging">[이전]</a>
							
							<%
								} else {
							%>
							<a href="recentlyViewed.do?page=<%=startPage - 1%>" id="paging">[이전]</a>
							<%
								}
							%>
							...
							%>
							<a href="recentlyViewed.do?page=<%=nowPage+1 %>" id="paging">[다음]</a>
							<%
								} else {
							%>
							<a href="recentlyViewed.do?page=<%=endPage+1%>" id="paging">[다음]</a>
							<%
								}
							%>
