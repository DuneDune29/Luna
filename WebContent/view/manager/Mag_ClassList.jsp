...
<jsp:include page="/side2.jsp" />
	...
	<br>
      ...
      <%
       ...
       <div><a href="Mag_classDetail.do?CL_ID=<%=classList.get(i).getCL_ID()%>&page=<%=nowPage %>" style="color:black; text-decoration: none;">  
...
<img src="<%=classList.get(i).getCL_IMG_PATH()%>" width=300px height=200px>
   ...
   <section id="pageList" style="text-align : center">
                     ...
                     %>
                     <a href="mag_classList.do?page=<%=startPage%>" id="paging">&lt;이전</a>
                     
                     <%
                        } else {
                     %>
                     <a href="mag_classList.do?page=<%=startPage - 1%>" id="paging">&lt;이전</a>
                     <%
                        }
                     %>
                     ...
                     %>
                     <a href="mag_classList.do?page=<%=nowPage+1 %>" id="paging">다음&gt;</a>
                     <%
                        } else {
                     %>
                     <a href="mag_classList.do?page=<%=endPage+1%>" id="paging">다음&gt;</a>
                     <%
                        }
                     %>
