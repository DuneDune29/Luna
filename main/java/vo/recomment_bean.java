...
public class recomment_bean {
	private int recomment_num;
	private int recomment_comment_num;
	private String recomment_content;
	private String recomment_id;
	private Date recomment_date;
	...
	public int getrecomment_comment_num() {
		return recomment_comment_num;
	}
	public void setrecomment_comment_num(int recomment_comment_num) {
		this.recomment_comment_num = recomment_comment_num;
	}
	...
	public Date getRecomment_date() {
		return recomment_date;
	}
	public void setRecomment_date(Date recomment_date) {
