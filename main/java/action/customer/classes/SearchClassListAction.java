...
import vo.PageInfo;
 ...
 public class SearchClassListAction implements Action {
	 ...
	 public ActionForward execute(HttpServletRequest request,HttpServletResponse response) throws Exception{ 
		 ...
		 ArrayList<ClassBean> article = new ArrayList<ClassBean>();
			int page = 1;
			int limit = 6;
			String CL_NAME = null;
			...
			if(CL_LOCATION != null) {
				article = searchClassListService.getSearchClassList(CL_NAME, CL_LOCATION, page, limit);
			} else {
				article = searchClassListService.getSearchClassList(CL_NAME, page, limit);
			}
			...
			forward.setPath("/view/customer/class/searchClassList.jsp");
			return forward;
